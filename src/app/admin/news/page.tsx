...
export default function AdminNews() {
 ...
 <Card key={news._id} className="border-0 shadow-none rounded-[2.5rem] bg-white overflow-hidden group hover:shadow-none transition-all duration-500">
 <CardHeader className="p-0 relative h-48 overflow-hidden bg-gray-100">
 {news.image ? (
 <img src={news.image} alt={news.title} className="w-full h-full object-cover group- transition-transform duration-700" />
 ) : (
 ...
 <span className="bg-white/90 backdrop-blur-md px-4 py-1.5 rounded-full text-sm font-black shadow-none">
 {news.category}
 </span>
 </div>
 </CardHeader>
