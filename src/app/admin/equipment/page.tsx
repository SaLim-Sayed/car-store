    ...
    <div className="min-h-screen bg-[#F9F6F1]">
      ...
      <main className="container mx-auto px-4 py-24">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-12">
          ...
          <Button asChild className="h-14 px-8 rounded-2xl text-lg font-black shadow-xl">
        ...
        {isLoading ? (
          ...
          <Card className="p-16 text-center border-0 shadow-xl rounded-[2.5rem] bg-white">
          ...
          <div className="grid gap-6">
            {items.map((item: Equipment) => (
              <Card key={item._id} className="border-0 shadow-xl rounded-[2rem] bg-white overflow-hidden">
