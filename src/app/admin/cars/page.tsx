...
export default function AdminCarsPage() {
 ...
 className="h-20 rounded-[2rem] border-0 shadow-none pr-16 pl-8 text-xl font-bold bg-white focus-visible:ring-primary/20"
 />
 </div>
 ...
 <div className="h-20 w-28 bg-white rounded-2xl overflow-hidden shadow-none border-2 border-white shrink-0">
 <img
 ...
 <td className="py-4 px-6 bg-gray-50/50">
 <Badge className={`${getStatusColor(car.status)} border-2 rounded-full px-4 py-1 font-black text-sm shadow-none`}>
 {car.status}
 </Badge>
 </td>
 ...
 <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-none">
