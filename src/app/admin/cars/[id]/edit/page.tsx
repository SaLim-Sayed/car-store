...
export default function EditCarPage() {
 ...
 <h1 className="text-5xl font-[1000] tracking-tighter">تعديل البيانات</h1>
 <p className="text-muted-foreground text-xl font-medium">تحديث تفاصيل {form.brand} {form.model}</p>
 ...
 {/* Basic Info */}
 <Card className="border-0 shadow-none rounded-[2.5rem] bg-white overflow-hidden">
 ...
 />
 <Button type="button" onClick={addImage} className="h-14 w-14 rounded-2xl shadow-none">
 ...
 <div key={idx} className="relative aspect-square group rounded-3xl overflow-hidden shadow-none border-4 border-white">
 <img
 src={img}
 alt={`صورة ${idx + 1}`}
 ...
 className="w-12 h-12 bg-white text-destructive rounded-full flex items-center justify-center shadow-none transition-transform"
 >
 <X className="h-6 w-6" />
 </button>
 </div>
 ...
 />
 <Button type="button" onClick={addFeature} className="h-14 px-8 rounded-2xl shadow-none">
 إضافة
 </Button>
 </div>
 ...
 <div
 key={idx}
 className="inline-flex items-center gap-2 bg-[#1A1A1A] text-white px-5 py-2.5 rounded-2xl text-lg font-black shadow-none"
 >
 {f}
 <button
 type="button"
 ...
 <Button type="submit" disabled={isLoading} className="flex-[2] h-16 rounded-2xl text-xl font-black shadow-none shadow-primary/20">
