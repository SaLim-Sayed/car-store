        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-8 border-b border-slate-200">
          <div className="space-y-1.5">
            <div className="flex items-center gap-2 text-slate-500 mb-2 font-bold text-sm">
              ...
              <span className="text-slate-800">تعديل {form.name}</span>
            </div>
            <h1 className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">تعديل بيانات المعرض</h1>
            <p className="text-sm md:text-base text-slate-500 font-bold max-w-2xl">
              تحديث بيانات المعرض وصورته في النظام
            </p>
          </div>
