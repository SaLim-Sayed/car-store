        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {showrooms.map((showroom: any) => (
              <Card key={showroom._id} className="border-0 shadow-xl rounded-[2.5rem] bg-white overflow-hidden group hover:shadow-2xl transition-all duration-500">
                <CardContent className="p-8 space-y-6">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-6">
                      <div className="h-20 w-20 bg-gray-50 rounded-2xl flex items-center justify-center border-2 border-gray-100 overflow-hidden shadow-inner">
                        {showroom.logo ? (
