...
export default function NewShowroomPage() {
 ...
 <div className="relative h-40 w-40 rounded-[2rem] overflow-hidden shadow-none border-4 border-white group bg-gray-50">
 <img
 src={form.logo}
 alt="معاينة"
 className="w-full h-full object-contain p-4 group- transition-transform duration-700"
 />
 <button
 type="button"
 onClick={() => setForm({ ...form, logo: "" })}
 className="absolute top-4 left-4 w-10 h-10 bg-white text-destructive rounded-full flex items-center justify-center shadow-none transition-transform"
 >
 <X className="h-5 w-5" />
 </button>
 </div>
