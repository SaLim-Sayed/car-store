...
export default function AdminDashboard() {
 ...
 <Card key={i} className="border-0 shadow-none rounded-[2rem]">
 ...
 <Card key={index} className="border-0 shadow-none rounded-[2.5rem] bg-white transition-transform duration-500">
 <CardContent className="p-8">
 ...
 <Button
 className="w-full h-16 rounded-2xl text-xl font-black bg-primary hover:bg-primary/90 text-white shadow-none shadow-primary/20"
 onClick={handleSeed}
 disabled={seeding}
 >
