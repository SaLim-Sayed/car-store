...
const privacySections = [
 ...
 icon: Shield,
 content: [
 "نحن في معرضنا نلتزم بحماية خصوصية بيانات عملائنا وضمان أمانها.",
 "توضح هذه السياسة كيفية جمعنا واستخدامنا وحمايتنا للبيانات الشخصية وفقاً للقوانين المعمول بها في جمهورية مصر العربية.",
 ...
 " - الامتثال: الالتزام الكامل بالقوانين المصرية لحماية البيانات"
 ]
 },
 {
 id: "cookies",
