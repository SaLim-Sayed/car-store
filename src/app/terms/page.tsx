...
const termsSections = [
  {
    ...
    icon: FileText,
    content: [
      "مرحباً بك في موقع شركة السيارات المتخصصة. باستخدامك لموقعنا وخدماتنا، فإنك توافق على الالتزام بالشروط والأحكام المذكورة أدناه.",
  ...
  },
  {
    ...
    content: [
      ...
      "الأسعار المعروضة تشمل جميع الرسوم القانونية والضريبية المطبقة في المملكة العربية السعودية.",
  ...
  },
  {
    ...
    content: [
      ...
      "يحظر استخدام الموقع لأي أغراض غير قانونية أو مخالفة للقوانين السعودية.",
  ...
  },
  {
    ...
    icon: DollarSign,
    content: [
      "جميع الأسعار المعروضة بالريال السعودي وتشمل ضريبة القيمة المضافة.",
  ...
  },
  {
    ...
    icon: FileText,
    content: [
      "جميع الحقوق الفكرية للموقع ومحتواه ملك لشركة السيارات المتخصصة.",
  ...
  },
  {
    ...
    icon: Shield,
    content: [
      "نحن نلتزم بحماية خصوصية بيانات العملاء وفقاً لنظام حماية البيانات الشخصية في المملكة.",
