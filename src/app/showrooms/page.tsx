...
function ShowroomsPageContent() {
 ...
 {[...Array(6)].map((_, index) => (
 <Card key={index} className="border-0 shadow-none rounded-2xl md:rounded-[2rem] bg-white overflow-hidden">
 ...
 <Card key={showroom._id} className="border-0 shadow-none rounded-2xl md:rounded-[2rem] bg-white overflow-hidden group hover:shadow-none transition-all duration-500 ">
 <CardContent className="p-4 md:p-6 space-y-4 md:space-y-6 h-full flex flex-col">
 <div className="flex items-start justify-between">
 <div className="flex items-center gap-4">
 <div className="h-14 w-14 md:h-20 md:w-20 bg-gray-50 rounded-lg md:rounded-xl flex items-center justify-center border-2 border-gray-100 overflow-hidden shadow-none group-hover:border-primary/20 transition-colors">
 {showroom.logo ? (
