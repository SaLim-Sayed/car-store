...
const contactInfo = [
  {
    icon: MapPin,
    title: "العنوان",
    details: ["مدينة المنيا. ميدان الحميات"],
  },
  {
    icon: Phone,
    title: "الهاتف",
    details: [SITE_PHONE_DISPLAY, "تواصل عبر واتساب متاح 24/7"],
  },

  {
    icon: Clock,
    title: "ساعات العمل",
    details: ["طوال ايام الاسبوع"],
  },
];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-200">
              سواء كنت تبحث عن سيارة جديدة أو تحتاج إلى خدمة فنية، فريقنا جاهز
              لمساعدتك
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {contactInfo.map((info, index) => (
              <Card
                key={index}
                className="text-center border-0 shadow-none hover:shadow-none transition-shadow"
              >
              ...
              <div>
                ...
                <div className="space-y-4">
                  {services.map((service, index) => (
                    <Card
                      key={index}
                      className="border-0 shadow-none hover:shadow-none transition-shadow"
                    >
                      <CardContent className="p-6">
