          ...
          <div className="flex w-full shrink-0 flex-col gap-4 rounded-2xl border border-neutral-200/80 bg-neutral-50/80 p-5 sm:max-w-md sm:self-end xl:w-[min(100%,19rem)] xl:self-stretch">
            <div className="flex items-center justify-center gap-2 sm:justify-end xl:order-2">
              <Button
                ...
                className="size-10 rounded-xl border-neutral-200/90 bg-background shadow-sm hover:bg-muted"
              >
        ...
        >
          <div className="min-w-0">
            <button
              ...
              className="group relative isolate block w-full cursor-zoom-in overflow-hidden rounded-2xl border border-neutral-200/65 bg-muted/35 text-start shadow-[inset_0_1px_0_rgb(255_255_255/0.6)] outline-none ring-primary/35 transition-[box-shadow,transform] hover:shadow-md focus-visible:ring-2 lg:rounded-[1.625rem]"
            >
          ...
          {images.length > 1 ? (
            <aside className="min-w-0 w-full lg:sticky lg:top-[7.75rem] xl:top-[8rem] [-ms-scrollbar-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              ...
              <div className="rounded-2xl border border-neutral-200/70 bg-neutral-50/90 p-2 shadow-inner ring-1 ring-black/[0.02]">
                <Swiper
                  modules={[FreeMode]}
                  dir="rtl"
                  freeMode
                    ...
                    >
                      <button
                        ...
                        className={`relative h-full w-full overflow-hidden rounded-[0.65rem] border transition-[box-shadow,border-color] outline-none cursor-zoom-in ${
                          selectedImage === index
                            ? "border-primary shadow-md shadow-primary/10 ring-[3px] ring-primary/20"
                            : "border-transparent bg-background/95 shadow-sm hover:border-neutral-300/90 hover:shadow"
                        }`}
                      >
                        <Image
                          src={image}
                ...
                <CardContent className="space-y-7 p-7 sm:p-8">
                  <div className="text-center space-y-4">
                    ...
                    <div className="flex flex-col items-center gap-3">
                      <div className="flex size-[4.5rem] items-center justify-center rounded-2xl border border-neutral-100 bg-gradient-to-b from-muted/80 to-muted/40 shadow-inner ring-4 ring-neutral-50">
                  ...
                  <div className="flex flex-col gap-3 pt-1">
                    <CallButton
                      phone={item.phone}
                      label="اتصال"
                      className="h-14 w-full min-h-14 shrink-0 rounded-xl border-0 bg-[#1d4ed8] text-base font-bold text-white shadow-md shadow-blue-950/15 hover:bg-[#1e40af]"
                    />
                    <Button
                      variant="outline"
                      size="xl"
