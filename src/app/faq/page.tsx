...
const faqs = [
 ...
 answer: "نحن نعمل من السبت إلى الخميس من 9:00 صباحاً إلى 10:00 مساءً، والجمعة من 2:00 مساءً إلى 10:00 مساءً، والأحد هو عطلتنا الرسمية. خدمة الطوارئ متاحة 24/7."
 },
 {
 category: "general",
 question: "هل تقدمون خدمة التوصيل؟",
 answer: "نعم، نقدم خدمة توصيل السيارات إلى جميع المحافظات في مصر. يمكن ترتيب التوصيل خلال 2-4 أيام عمل حسب الموقع."
 },
 {
 category: "cars",
 ...
 answer: "بالتأكيد! نشجع جميع العملاء على تجربة السيارة. يمكنك حجز موعد تجربة قيادة عبر موقعنا أو بزيارة فرعنا في المنيا."
 },
 {
 category: "financing",
 question: "ما هي شروط الحصول على تمويل؟",
 answer: "الشروط الأساسية: عمر لا يقل عن 21 سنة، دخل شهري لا يقل عن 7,000 جنيه، إقامة سارية للمقيمين، وخلو من السجل الائتماني السلبي (I-Score)."
 },
 {
 category: "financing",
 question: "كم تستغرق عملية الموافقة على التمويل؟",
 answer: "عملية الموافقة تستغرق عادة 48 ساعة من تقديم جميع المستندات المطلوبة. في بعض الحالات قد تكون أسرع إذا كانت جميع المعلومات كاملة."
 },
 {
 category: "warranty",
