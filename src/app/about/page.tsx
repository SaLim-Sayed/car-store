...
const teamMembers = [
  {
    ...
    bio: "خبير في صناعة السيارات بخبرة تزيد عن 15 عاماً في السوق السعودي"
  },
  {
    name: "سارة عبدالله",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              رائداً في عالم السيارات في المملكة العربية السعودية
            </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    تأسست شركة السيارات المتخصصة في عام 2009 بشغف عميق بالسيارات ورغبة في تقديم تجربة شراء فريدة للعملاء في المملكة العربية السعودية.
                  </p>
                  <p>
