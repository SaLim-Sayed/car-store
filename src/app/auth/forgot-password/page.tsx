      ...
      >
        <div className="flex flex-col items-center gap-6 py-4 text-center">
          ...
          <p className="text-muted-foreground font-medium leading-relaxed">
            إذا كان البريد مسجلاً لدينا، ستصلك رسالة تحتوي على رابط إعادة
            التعيين خلال دقائق.
          </p>
          {devResetUrl && (
            <div className="w-full rounded-xl border border-amber-200 bg-amber-50 p-4 text-right text-sm">
              <p className="mb-2 font-black text-amber-900">
                وضع التطوير — رابط إعادة التعيين:
              </p>
              <a
                href={devResetUrl}
  ...
  return (
    <AuthLayout
      ...
      footer={
        <Link
          href="/auth/login"
          className="inline-flex items-center gap-2 font-black text-accent hover:underline"
        >
