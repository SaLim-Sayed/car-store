...
const financingOptions = [
  {
    ...
    features: [
      "فائدة تنافسية تبدأ من 2.5%",
      "فترة سداد تصل إلى 7 سنوات",
      "مبلغ تمويل يصل إلى 500,000 ريال",
      "موافقة سريعة خلال 24 ساعة"
    ],
    interestRate: "2.5% - 4.5%",
    maxAmount: "500,000 ريال",
    maxPeriod: "7 سنوات",
    popular: true
  },
  {
    icon: Home,
    title: "تمويل إسلامي",
    description: "تمويل متوافق مع الشريعة الإسلامية بدون ربا",
    features: [
      "مرابحة وتأجير منتهي بالتمليك",
      "هوامش ربح تنافسية",
      "شفافية كاملة في التكاليف",
      "شهادة من هيئة الرقابة الشرعية"
    ],
    interestRate: "3% - 5% (هامش الربح)",
    maxAmount: "400,000 ريال",
    maxPeriod: "6 سنوات"
  },
  {
    icon: PiggyBank,
    title: "تمويل للشركات",
    description: "حلول تمويلية متخصصة للشركات والمؤسسات",
    features: [
...
const requirements = [
  {
    ...
    title: "الشروط العامة",
    items: [
      "سعودي الجنسية أو مقيم إقامة سارية",
      "عمر المتقدم لا يقل عن 21 سنة",
      "راتب شهري لا يقل عن 5,000 ريال",
      "خلو من السجل الائتماني السلبي"
    ]
  },
  {
    icon: FileText,
