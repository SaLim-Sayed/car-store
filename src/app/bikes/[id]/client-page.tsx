          ...
          >
            <div className="group/main-slider relative isolate min-w-0 overflow-hidden rounded-[1.25rem] border border-neutral-200/70 bg-white shadow-[0_8px_30px_-12px_rgb(15_23_42/0.12)] ring-1 ring-black/[0.04] sm:rounded-[1.5rem] lg:rounded-[1.625rem]">
              <Swiper
                ...
                modules={[Navigation]}
                navigation={{
                  prevEl: ".bike-main-slider-prev",
                  nextEl: ".bike-main-slider-next",
                }}
                grabCursor
              >
                {images.map((img, idx) => (
              ...
              {images.length > 1 && (
                <>
                  ...
                  <button
                    type="button"
                    className="bike-main-slider-next absolute right-3 top-1/2 z-20 flex size-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/95 text-slate-800 shadow-lg ring-1 ring-black/5 transition hover:bg-white sm:right-4"
                  ...
                  <button
                    type="button"
                    className="bike-main-slider-prev absolute left-3 top-1/2 z-20 flex size-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/95 text-slate-800 shadow-lg ring-1 ring-black/5 transition hover:bg-white sm:left-4"
                    onClick={(e) => e.stopPropagation()}
            ...
            {images.length > 1 ? (
              <aside className="min-w-0 w-full lg:sticky lg:top-28 xl:top-32">
                ...
                <div className="relative rounded-[1.1rem] border border-neutral-200/80 bg-white p-2 shadow-sm ring-1 ring-black/[0.03]">
                  <button
                    type="button"
                    className="bike-thumb-prev absolute right-1 top-1/2 z-10 flex size-8 -translate-y-1/2 items-center justify-center rounded-full bg-white text-slate-700 shadow-md ring-1 ring-black/5 transition hover:bg-slate-50 lg:right-1/2 lg:top-1 lg:translate-x-1/2 lg:translate-y-0"
                  ...
                  <button
                    type="button"
                    className="bike-thumb-next absolute left-1 top-1/2 z-10 flex size-8 -translate-y-1/2 items-center justify-center rounded-full bg-white text-slate-700 shadow-md ring-1 ring-black/5 transition hover:bg-slate-50 lg:bottom-1 lg:left-1/2 lg:top-auto lg:-translate-x-1/2 lg:translate-y-0"
                  ...
                  <Swiper
                    ...
                    navigation={{
                      prevEl: ".bike-thumb-prev",
                      nextEl: ".bike-thumb-next",
                    }}
