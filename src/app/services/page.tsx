...
const services = [
  ...
  },
  {
    ...
    description: "خدمة فنية متخصصة لجميع أنواع السيارات بفريق محترف",
    features: [
      "فنيون معتمدون",
      "قطع غيار أصلية",
      "ضمان على الخدمة",
  ...
  },
  {
    ...
    description: "أفضل شركات التأمين مع تغطية شاملة وأسعار ممتازة",
    features: [
      "تغطية شاملة",
      "معالجة سريعة",
      "أسعار تنافسية",
    ...
    price: "يبدأ من 1,500 ريال سنوياً"
  },
  {
    icon: Clock,
    title: "خدمة الطوارئ",
    description: "خدمة سريعة على مدار الساعة للطوارئ على الطريق",
    features: [
      "استجابة سريعة",
      "خدمة 24/7",
      "فريق متخصص",
