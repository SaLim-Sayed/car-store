...
/** كلمات مفتاحية عامة — مستوحاة من بحث هتلاقي / أولكس / كونتاكت كارز / يلاموتور */
export const GLOBAL_ARABIC_KEYWORDS = [
  // النية الأساسية (المنيا)
  "سيارات مستعملة للبيع في المنيا",
  "سيارات للبيع في المنيا",
  "سيارات مستعملة المنيا",
  "سعر سيارات في المنيا",
  "اسعار السيارات المستعملة في المنيا",
  "سيارات المنيا",
  "سوق سيارات المنيا",
  "بيع سيارات المنيا",
  "شراء سيارات المنيا",
  "عربيات للبيع في المنيا",
  "عربيات مستعملة المنيا",
  "حراج سيارات المنيا",
  "إعلانات سيارات المنيا",
  "سوق سيارات المنيا بدون وسيط",
  "جروب سوق سيارات المنيا",
  "جروب سوق سيارات المنيا مستعملة",

  // تقسيط وكاش (كونتاكت كارز / هتلاقي)
  "سيارات مستعملة للبيع بالتقسيط في المنيا",
  "سيارات للبيع بالتقسيط في المنيا",
  "سيارات كاش المنيا",
  "سيارات تقسيط وكاش المنيا",
  "سيارات مستعملة بأفضل سعر تقسيط وكاش",

  // ناقل / حالة
  "سيارات اتوماتيك للبيع في المنيا",
  "سيارات مانيوال للبيع في المنيا",
  "سيارات فابريكا المنيا",
  "سيارات استيراد للبيع في المنيا",
  "سيارات زيرو المنيا",
  "سيارات جديدة للبيع في المنيا",

  // مراكز المنيا (كونتاكت كارز / أولكس)
  "سيارات للبيع في سمالوط",
  "سيارات مستعملة سمالوط",
  "سيارات للبيع في بني مزار",
  "سيارات للبيع في مغاغة",
  "سيارات للبيع في ملوي",
  "سيارات للبيع في أبو قرقاص",
  "سيارات للبيع في مطاي",
  "سيارات للبيع في دير مواس",
  "سيارات للبيع في العدوة",
  "سيارات صفط الخمار",
  "سيارات أرض السلطان",

  // موديلات شائعة في المنيا (أولكس / هتلاقي)
  "سيارات للبيع في المنيا شاهين",
  "فيات شاهين للبيع في المنيا",
  "هيونداي أكسنت للبيع في المنيا",
  "شيفروليه افيو للبيع في المنيا",
  "أوبل أسترا للبيع في المنيا",
  "دايو لانوس للبيع في المنيا",
  "كيا برايد للبيع في المنيا",
  "رينو ميجان للبيع في المنيا",
  "أوبل فيكترا للبيع في المنيا",

  // مقارنة بمواقع البيع
  "  هتلاقي المنيا",
  "  أولكس سيارات المنيا",
  "  كونتاكت كارز المنيا",
  "هتلاقي سيارات المنيا",
  "أولكس سيارات المنيا",
  "دوبيزل سيارات المنيا",
  "كونتاكت كارز المنيا",
  "يلاموتور سيارات المنيا",
...
export const STATIC_PAGE_SEO = {
  home: {
    ...
    description:
      "سيارات مستعملة للبيع في المنيا بأفضل سعر تقسيط وكاش. إعلانات موثوقة من معارض وأفراد — قارن العروض وتواصل مباشرة بدون وسيط، بديل هتلاقي وأولكس وكونتاكت كارز في المنيا.",
    path: "",
    keywords: [
      "سيارات مستعملة للبيع في المنيا",
      "سيارات مستعملة بأفضل سعر تقسيط وكاش",
      ...
      "سوق سيارات المنيا بدون وسيط",
      "بديل هتلاقي المنيا",
      "بديل أولكس سيارات المنيا",
      "بديل كونتاكت كارز المنيا",
      "إعلانات سيارات المنيا",
      "شراء عربيات",
  ...
  cars: {
    title: "سيارات مستعملة للبيع في المنيا بأفضل سعر تقسيط وكاش",
    description:
      "اشترِ أفضل السيارات المستعملة في المنيا بأسعار لا تُضاهى. إعلانات محدثة في المنيا وسمالوط وبني مزار ومغاغة وملوي — قارن العروض، اختر كاش أو تقسيط، وتواصل مع البائعين فوراً بدون وسيط.",
    path: "cars",
    keywords: [
      "سيارات مستعملة للبيع في المنيا",
      "سيارات مستعملة للبيع في المنيا بأفضل سعر تقسيط وكاش",
      "سعر سيارات في المنيا",
      "اسعار السيارات المستعملة في المنيا",
      "سيارات مستعملة للبيع بالتقسيط في المنيا",
      "سيارات اتوماتيك للبيع في المنيا",
...
export const CARS_MARKET_FAQ = [
  {
    ...
    answer:
      "تختلف أسعار السيارات المستعملة في المنيا حسب الماركة والموديل والحالة والكيلومترات. على سوق سيارات المنيا يمكنك تصفّح إعلانات محدثة يومياً مثل هتلاقي وأولكس وكونتاكت كارز، مقارنة الأسعار بين المعارض والأفراد، والتواصل مع البائع مباشرة بدون وسيط.",
  },
  {
    question: "أين أجد سيارات مستعملة للبيع في المنيا؟",
    answer:
      "يمكنك تصفّح إعلانات السيارات المستعملة في المنيا وسمالوط وبني مزار ومغاغة وملوي وأبو قرقاص على موقع سوق سيارات المنيا، مع فلترة حسب السعر والماركة ونوع الناقل والوقود — كاش أو تقسيط.",
  },
  {
    question: "هل توجد سيارات مستعملة للبيع بالتقسيط في المنيا؟",
    answer:
      "نعم، بعض المعارض والبائعين يعرضون سيارات بالتقسيط أو كاش. تصفّح قسم التمويل أو تواصل مع المعرض مباشرة من صفحة الإعلان للاستفسار عن خطط التقسيط المتاحة.",
  },
  {
    question: "ما أفضل سيارة بسعر 200 ألف جنيه في مصر؟",
    answer:
      "يعتمد الاختيار على احتياجك اليومي. في هذا السعر غالباً تجد موديلات مثل شيفروليه افيو أو أوبل أسترا أو هيونداي أكسنت أو فيات شاهين مستعملة. قارن الإعلانات المتاحة في المنيا على موقعنا واختر الأنسب بعد المعاينة والفحص.",
  },
  {
    question: "هل يمكن شراء سيارة أوتوماتيك في المنيا؟",
    answer:
      "نعم، يتوفر قسم خاص بسيارات الأوتوماتيك في إعلاناتنا. استخدم فلاتر البحث لتصفية السيارات الأوتوماتيك أو المانيوال المعروضة للبيع في المنيا والصعيد.",
  },
] as const;
...
export function buildCarsCollectionJsonLd() {
  ...
  return {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
    name: "سيارات مستعملة للبيع في المنيا بأفضل سعر تقسيط وكاش",
    ...
    about: {
      ...
      description:
        "إعلانات سيارات مستعملة وجديدة للبيع في المنيا وسمالوط وبني مزار ومغاغة وملوي — تقسيط وكاش بدون وسيط",
    },
    breadcrumb: {
      "@type": "BreadcrumbList",
      itemListElement: [
