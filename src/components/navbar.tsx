...
import { User, Car, LogOut, Settings, PlusCircle, Menu, X, Mail } from "lucide-react";
                  ...
                  {user?.role === "admin" && (
                    <>
                      <DropdownMenuItem asChild>
                        <Link href="/admin/cars" className="w-full cursor-pointer">
              ...
              >
                <div className="flex items-center justify-between p-4 border-b">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold">متجر السيارات</span>
                  </div>
                  <Button
                    variant="ghost"
                    size="icon"
                ...
                <div className="flex-1 overflow-y-auto p-4">
                  <nav className="flex flex-col space-y-2">
                    {navLinks.map((link) => {
                      const Icon = link.href === "/" ? Car : link.href === "/cars" ? Car : Settings; // Fallback icons
                      return (
                        <Link
                          key={link.href}
                          href={link.href}
                        ...
                        >
                          ...
                          {link.href === "/news" && <PlusCircle className="h-5 w-5" />}
                          {link.label}
                        </Link>
                      );
                    })}
