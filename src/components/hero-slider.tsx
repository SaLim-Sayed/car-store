...
export function HeroSlider() {
 ...
 <div className="bg-white p-2 md:p-4 rounded-xl shadow-none mt-8 mx-auto max-w-3xl">
 <GlobalSearch variant="hero" placeholder="ابحث بالماركة، الموديل، أو الكلمات المفتاحية..." />
 </div>
 </div>
 </section>
 );
