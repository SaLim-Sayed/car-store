    ...
    <div ref={containerRef} className={cn('relative w-full', className)}>
      <div
        className={cn(
          ...
          isNavbar &&
            'h-10 md:h-11 rounded-xl border border-gray-200 bg-white/90 backdrop-blur-sm shadow-sm focus-within:ring-2 focus-within:ring-primary/20'
        )}
      >
        <Search
          className={cn(
      ...
      {open && (() => {
        ...
        <div
          ref={dropdownRef}
          className={cn(
            'fixed z-[9999] overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-2xl',
