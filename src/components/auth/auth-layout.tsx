  ...
  return (
    <div className="min-h-screen bg-[#F9F6F1]">
      <div className="grid min-h-screen lg:grid-cols-2">
        <div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-[#1A1A1A] p-12 text-white">
          ...
          <div className="relative z-10">
            <Link href="/" className="inline-flex items-center gap-4 transition-opacity hover:opacity-90">
              <div className="relative h-16 w-16 overflow-hidden rounded-2xl border-2 border-primary/40 shadow-xl">
              ...
              <div className="space-y-1 text-right">
                ...
                <p className="text-3xl font-[1000] tracking-tight">سيارات المنيا</p>
              </div>
            </Link>
          </div>
          ...
          <div className="relative z-10 space-y-8">
            <div className="space-y-4">
              <h2 className="text-4xl font-[1000] leading-tight tracking-tight">
                بوابتك لعالم
                <br />
                <span className="text-primary">السيارات في المنيا</span>
              </h2>
              <p className="max-w-md text-lg text-white/70 font-medium leading-relaxed">
                سجّل دخولك لإدارة إعلاناتك، أو أنشئ حساباً جديداً وابدأ البيع والشراء بكل سهولة.
              </p>
            </div>
        ...
        <div className="flex flex-col justify-center px-4 py-10 sm:px-8 lg:px-14">
          <div className="mx-auto w-full max-w-md space-y-8">
            <Link href="/" className="flex lg:hidden items-center justify-center gap-3">
              <div className="relative h-14 w-14 overflow-hidden rounded-xl border-2 border-primary/20 shadow-lg">
                <Image src="/logo-maarad-sayarat.png" alt="سيارات المنيا" fill className="object-cover" />
              </div>
            ...
            <div className="rounded-[2rem] border border-white/80 bg-white p-8 shadow-[0_20px_60px_rgba(0,0,0,0.06)] sm:p-10">
              <header className="mb-8 space-y-2 text-center">
                <h1 className="text-3xl font-[1000] tracking-tight text-foreground">{title}</h1>
                <p className="text-muted-foreground font-medium leading-relaxed">{subtitle}</p>
            ...
            {footer && (
              <footer className="text-center text-sm text-muted-foreground font-medium">{footer}</footer>
            )}
          </div>
        </div>
      </div>
